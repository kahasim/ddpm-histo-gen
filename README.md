...
<p align="center">
    <img src="https://github.com/sunnydigital/ddpm-histo-gen/blob/main/assets/slide1.png" alt="Slide 1" width="100%">
    <img src="https://github.com/sunnydigital/ddpm-histo-gen/blob/main/assets/slide2.png" alt="Slide 2" width="100%">
</p>
...
- [x] Fully debugging/completing class integration of the initial **classed** DDPM model. ✅ Fixed: funny enough this was due to creating an initial time embedding `t` as a `torch.tensor` instead of `np.ndarray` when converting from functions to classes, causing the tensor to be added onto the computational graph and gradients backpropogated.
